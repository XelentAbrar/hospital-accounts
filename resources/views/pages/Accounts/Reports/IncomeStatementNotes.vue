<template>
<Head title="Notes to Income Statement" />
<AppLayout title="Notes to Income Statement">
    <div class="bg-white shadow sm:rounded-lg">
    <div class="px-4 py-6 sm:px-6">
        <h3 class="font-semibold text-4xl text-primary">Notes to Income Statement</h3>
    </div>
    <div class="border-t border-gray-100 py-2 px-4">
        <form @submit.prevent="filter.get(route('income-statement-notes'), filter); isLoading = true">
                ...
                <div class="mt-2 flow-root" id="printData">
                    <div style="font-family: Arial, Helvetica, sans-serif; padding: 20px;display: flex;flex-direction: column;">
                        <div class="print-only">
                            ...
                            <div>
                                <p style="font-size: 22px;line-height:1.2;font-weight: 500;text-align: center;margin: 0;margin-bottom: 10px;">Income Statement Notes</p>
                            </div>
